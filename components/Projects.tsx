                  ...
                  <article className="glass-panel flex h-full flex-col rounded-2xl p-5">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {p.stack.map((s) => (
                        <span
                          key={s}
                          className="rounded-full border border-[var(--color-border)] bg-[var(--color-surface-0)]/90 px-2.5 py-0.5 font-mono text-[11px] text-slate-400 transition-colors hover:border-[var(--color-accent)]/30 hover:text-slate-200"
                        >
                          {s}
                        </span>
                      ))}
                    ...
                    <div className="mt-6 flex flex-wrap gap-6 border-t border-[var(--color-border)] pt-4">
                      ...
                      {p.liveUrl ? (
                        <Link
                          ...
                          className="inline-flex items-center gap-1 text-sm font-medium text-slate-300 transition-all hover:gap-2 hover:text-white"
                        >
                          Live Demo →
                        </Link>
                      ) : null}
