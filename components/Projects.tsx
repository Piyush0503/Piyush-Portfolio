...
export function Projects() {
  return (
    <section
      id="projects"
      className="scroll-mt-24 border-t border-[var(--color-border)] bg-[var(--color-surface-1)] py-20 sm:py-28"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <ul className="mt-12 grid gap-6 sm:grid-cols-2">
          {projects.map((p, i) => (
            <li key={p.title}>
              <Reveal delay={i * 0.1}>
                <article className="glass-panel flex h-full flex-col rounded-2xl p-6 transition-transform duration-300 hover:scale-[1.01] hover:shadow-[0_0_0_1px_rgba(0,229,255,0.1)]">
