...
export function AboutStrip() {
  return (
    <section
      id="about"
      className="scroll-mt-24 border-y border-[var(--color-border)] bg-[var(--color-surface-1)]/80 py-14 sm:py-16"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal>
          <div className="glass-panel cta-glow-border rounded-2xl px-6 py-8 sm:px-10 sm:py-10">
