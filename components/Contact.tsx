...
export function Contact() {
  ...
  return (
    <section id="contact" className="scroll-mt-24 py-section sm:py-section-lg">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal>
          <div className="glass-panel cta-glow-border rounded-3xl px-5 py-10 text-center sm:px-10 sm:py-12">
        ...
        <Reveal delay={0.12} className="mt-10 block">
          <div
            id="contact-form"
            className="scroll-mt-28 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-1)]/60 p-5 sm:p-8"
          >
